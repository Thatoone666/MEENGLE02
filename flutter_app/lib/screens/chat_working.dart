...
class ChatScreenWorking extends StatefulWidget {
  final String matchId;
  final String matchName;
  final String? matchImage;

  const ChatScreenWorking({
    super.key,
  ...
  @override
  State<ChatScreenWorking> createState() => _ChatScreenWorkingState();
}

class _ChatScreenWorkingState extends State<ChatScreenWorking> {
