...
import '../widgets/cards/story_card.dart';
...
class _StoriesScreenState extends State<StoriesScreen>
                          ...
                          return FadeTransition(
                            ...
                            child: ScaleTransition(
                              ...
                              child: StoryCard(
                                ...
                                onReact: () =>
                                    provider.reactToStory(story.id),
                              ),
                            ),
                          );
                        },
      ...
      builder: (context) => ScaleTransition(
        ...
        child: AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                context.read<StoriesProvider>().uploadStory(
  ...
  void _viewStory(BuildContext context, dynamic story) {
    showDialog(
      context: context,
      builder: (context) => ScaleTransition(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    _buildStoryActionButton(Icons.favorite_outline),
                    _buildStoryActionButton(Icons.comment_outlined),
                    _buildStoryActionButton(Icons.share_outlined),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildStoryActionButton(IconData icon) {
    return Container(
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        color: Colors.white.withAlpha(51),
