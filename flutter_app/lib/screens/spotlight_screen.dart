              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    for (int i = 0; i < provider.tiers.length; i++)
                      FadeTransition(
                        opacity: Tween<double>(begin: 0, end: 1)
                            .animate(
                          CurvedAnimation(
                            parent: _contentController,
                            curve: Interval(
                              (0.3 + (i * 0.12)).clamp(0.0, 0.9),
                              (0.3 + ((i + 1) * 0.12)).clamp(0.0, 1.0),
                              curve: Curves.easeOut,
                            ),
                          ),
                        ),
                        child: ScaleTransition(
                          ...
                          child: SpotlightTierCard(
                            tier: provider.tiers[i],
                            isActive: provider.activeSpotlight?.tier ==
                                provider.tiers[i].name,
                            onPurchase: () =>
                                _purchaseSpotlight(context, provider.tiers[i]),
                          ),
                        ),
                      ),
                  ],
        ...
        child: AlertDialog(
          ...
          actions: [
            ...
            GlowingButton(
              ...
              onPressed: () {
                context
                    .read<SpotlightProvider>()
                    .purchaseSpotlight(tier.name);
