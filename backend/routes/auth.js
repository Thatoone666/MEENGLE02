...
router.post('/profile', verifyToken, async (req, res) => {
  try {
    const { age, bio, gender, genderPreference, photos, interests, location, ageRange, religion, bodyType, educationLevel, relationshipGoal, filterPreferences } = req.body;
    ...
    // Handle location (GeoJSON format: [longitude, latitude])
